...
RSpec.describe DaysController, type: :controller do
	...
	before(:each) do
	  ...
	  @user2 = User.create(name: "Linda") 
		...
		@day1 = Day.create(date: '6-8-2015', user: @user1)
		@day2 = Day.create(date: '7-8-2015', user: @user2)
		@date_requesting_swap = '6-8-2015'

		params = {day: {swap_request: @date_requesting_swap, day_id: @day2.id}}
	...
	describe "PUT #confirm_swap" do
		...
		before(:each) do
			@day1.reload
			@day2.reload
			params = {day: {first_day_id: @day2.id, second_day_id: @day1.id}}
